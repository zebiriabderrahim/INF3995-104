...
echo_and_run cd "/home/nvidia/INF3995-104/embedded/agilex_ws/src/src/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/home/nvidia/INF3995-104/embedded/agilex_ws/src/src/cv_bridge/setup.py" \
     \
    build --build-base "/mnt/home/nvidia/INF3995-104/embedded/agilex_ws/build/src/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
