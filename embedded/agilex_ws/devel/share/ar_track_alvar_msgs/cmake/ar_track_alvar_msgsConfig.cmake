...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/src/detect_mark/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/install)
...
if(NOT "/home/nvidia/INF3995-104/embedded/agilex_ws/devel/include " STREQUAL " ")
  set(ar_track_alvar_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/INF3995-104/embedded/agilex_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/INF3995-104/embedded/agilex_ws/src/detect_mark/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
