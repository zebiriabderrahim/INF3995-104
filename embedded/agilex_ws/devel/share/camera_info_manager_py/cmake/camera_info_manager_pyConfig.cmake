...
if("TRUE" STREQUAL "TRUE")
  set(camera_info_manager_py_SOURCE_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/src/src/camera_info_manager_py)
  set(camera_info_manager_py_DEVEL_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/devel)
  ...
  set(camera_info_manager_py_INSTALL_PREFIX /home/nvidia/INF3995-104/embedded/agilex_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_info_manager_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/INF3995-104/embedded/agilex_ws/src/src/camera_info_manager_py/${idir}'.  ${_report}")
    endif()
